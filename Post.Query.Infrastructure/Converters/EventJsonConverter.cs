...
namespace Post.Query.Infrastructure.Converters
{
  ...
  {
    //We can only convert the JSON if the type is assignable or extends base event.
    ...
    public override BaseEvent Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
      ...
      //the type property we use as the discriminator,
      //It identifies the specifyc concrete event type
